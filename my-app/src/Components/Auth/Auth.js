...
class Auth extends Component {
    ...
    render() {
                    ...
                    {({values,handleChange,handleSubmit,errors})=>(<div  style={{
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            {this.state.mode === "Sign Up" ? <div>
                                <input name="passwordConfirm" placeholder=" Enter Confirm Password" className="form-control" value={values.passwordConfirm} onChange={handleChange}/>
        ...
        return (
            <div className="container col-md-6 col-sm-12 offset-md-3  mt-5">
                {error}
                {form}
            </div>
        );
